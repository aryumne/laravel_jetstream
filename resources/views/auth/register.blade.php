...
{{-- <div class="container d-flex flex-column">
    <div class="row align-items-center justify-content-center g-0
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xxl-4 py-8 py-xl-0">
            <!-- Card -->
            <a href="/"><img src="{{asset('/images/navbrand-kumham.png')}}" class="mb-3 img-fluid mx-auto" style="height:60px;  margin-top:-50px;" alt=""></a>
                ...
                <div class="card-body p-6">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" id="email" class="form-control" ype="email" name="email" :value="old('email')" required placeholder="Email address here">
                        </div>
                        <!-- Password -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <div class="form-check custom-checkbox">
                                ...
                                <label class="form-check-label" for="agreeCheck"><span class="fs-5">
                                        {!! __('I agree to the :terms_of_service and :privacy_policy', [
                        ...
                        <div>
                            ...
                            <div class="d-md-flex justify-content-between mt-4">
                                <div class="mb-2 mb-md-0">
                                    <a href="{{ route('login') }}" class="fs-5">Already registered?</a>
                                </div>
                                <div>
